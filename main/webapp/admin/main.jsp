...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="${pageContext.request.contextPath}/admin/main.jsp" class="logo">
            <span class="logo-lg"><b>港湾船只管理系统</b></span>
        </a>
        <!-- 头部导航 -->
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li >
                    <a href="${pageContext.request.contextPath}/ship/search" target="iframe">
                        <i class="fa fa-circle-o"></i>船只停泊
                    </a>
                </li>
                <li>
                    <a href="${pageContext.request.contextPath}/ship/searchBerthing" target="iframe">
                        <i class="fa fa-circle-o"></i>当前停泊
                    </a>
                </li>
                <li >
                    <a href="${pageContext.request.contextPath}/record/searchRecords" target="iframe">
                        <i class="fa fa-circle-o"></i>停泊记录
                    </a>
                </li>
            </ul>
        </section>
    ...
    <div class="content-wrapper">
        <iframe width="100%" id="iframe" name="iframe" onload="SetIFrameHeight()"
                frameborder="0" src="${pageContext.request.contextPath}/ship/selectNewShips"></iframe>
    </div>
</div>
</body>
</html>